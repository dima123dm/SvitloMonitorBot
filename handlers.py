...
async def handle_text_messages(message: types.Message):
    """
    Цей хендлер ловить ВСІ текстові повідомлення.
    """
    ...
    if user_id == ADMIN_ID and mode == "broadcast":
        ...
        await db.set_user_mode(ADMIN_ID, "normal")
        # ВИПРАВЛЕНО: Додано текст повідомлення
    ...
    # Якщо користувач просто пише текст без режиму (наприклад, "Привіт")
    # Можна ігнорувати або відповісти, що бот не розуміє
    # await message.answer("ℹ️ Скористайтеся меню для навігації.")